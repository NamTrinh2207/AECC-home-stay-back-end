...
public interface IBookingRepository extends JpaRepository<Booking, Long> {
    @Query(nativeQuery = true, value = "SELECT h.id, h.address as address, h.rating, h.bedroom, h.bathroom, h.name as name, h.price_by_day as pricebyday, ht.name as hometype, u.name as username,  COUNT( DISTINCT b.id) AS bookingcount,\n" +
